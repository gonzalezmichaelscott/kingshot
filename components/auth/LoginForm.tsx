...
export function LoginForm() {
  ...
  if (sent) {
    return (
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 text-center">
        ...
        <button onClick={() => setSent(false)} className="mt-4 text-amber-500 text-sm hover:text-amber-400">
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-4">
      <h2 className="font-semibold text-center">Sign in to Kingshot Hub</h2>
      ...
      <div className="space-y-2">
        ...
        <Button variant="secondary" className="w-full" onClick={handleDiscord}>
